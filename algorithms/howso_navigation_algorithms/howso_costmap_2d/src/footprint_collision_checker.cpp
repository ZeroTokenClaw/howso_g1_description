...
#include "howso_costmap_2d/exceptions.hpp"
#include "howso_costmap_2d/footprint.hpp"
#include "howso_util/line_iterator.hpp"
...
double FootprintCollisionChecker<CostmapT>::lineCost(int x0, int x1, int y0, int y1) const
{
  ...
  for (howso_util::LineIterator line(x0, y0, x1, y1); line.isValid(); line.advance()) {
...
template class FootprintCollisionChecker<std::shared_ptr<howso_costmap_2d::Costmap2D>>;
template class FootprintCollisionChecker<howso_costmap_2d::Costmap2D *>;

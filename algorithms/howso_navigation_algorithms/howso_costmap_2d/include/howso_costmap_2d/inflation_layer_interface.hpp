...
#ifndef HOWSO_COSTMAP_2D__INFLATION_LAYER_INTERFACE_HPP_
#define HOWSO_COSTMAP_2D__INFLATION_LAYER_INTERFACE_HPP_
    ...
    const std::string layer_name = "")
  {
      ...
      ++layer)
    {
      auto inflation_layer =
        std::dynamic_pointer_cast<howso_costmap_2d::InflationLayerInterface>(*layer);
      if (inflation_layer) {
...
#endif  // HOWSO_COSTMAP_2D__INFLATION_LAYER_INTERFACE_HPP_

...
class TestObstacleLayer : public howso_costmap_2d::ObstacleLayer
{
public:
  void addObservationBuffer(std::shared_ptr<howso_costmap_2d::ObservationBuffer> buffer)
  {
...
public:
  void SetUp(benchmark::State & /*state*/)
  {
    ...
    buffer_ =
      std::make_shared<howso_costmap_2d::ObservationBuffer>(node_, "/observations", 10.0,
  ...
  howso_costmap_2d::LayeredCostmap layers_{global_frame, false, false};
  std::shared_ptr<howso_costmap_2d::ObservationBuffer> buffer_{};
...
BENCHMARK_F(ObservationBufferFixture, AddCloudsAndGetObersvations)(benchmark::State & state)
{
  for (auto _ : state) {
    ...
    std::vector<howso_costmap_2d::Observation::ConstSharedPtr> observations{};

...
{
  std::shared_ptr<howso_costmap_2d::Costmap2D> costmap_ =
    std::make_shared<howso_costmap_2d::Costmap2D>(100, 100, 0.1, 0, 0, 0);
  ...
  howso_costmap_2d::FootprintCollisionChecker<std::shared_ptr<howso_costmap_2d::Costmap2D>>
...
{
  std::shared_ptr<howso_costmap_2d::Costmap2D> costmap_ =
    std::make_shared<howso_costmap_2d::Costmap2D>(100, 100, 0.1, 0, 0, 254);
...
{
  std::shared_ptr<howso_costmap_2d::Costmap2D> costmap_ =
    std::make_shared<howso_costmap_2d::Costmap2D>(100, 100, 0.10000, 0, 0.0, 0.0);
...
TEST(collision_footprint, not_enough_points)
{
  ...
  std::tie(min_dist, max_dist) = howso_costmap_2d::calculateMinAndMaxDistances(footprint);
...
TEST(collision_footprint, to_point_32) {
  ...
  p32 = howso_costmap_2d::toPoint32(p);
...
TEST(collision_footprint, to_polygon) {
  ...
  poly = howso_costmap_2d::toPolygon(pts);
...
TEST(collision_footprint, make_footprint_from_string) {
  ...
  bool result = howso_costmap_2d::makeFootprintFromString(

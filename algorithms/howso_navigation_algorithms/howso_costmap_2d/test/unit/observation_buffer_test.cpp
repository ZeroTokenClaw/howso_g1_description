...
protected:
  ...
  howso::LifecycleNode::SharedPtr node_{std::make_shared<howso::LifecycleNode>(
      "observation_buffer_test_node")};
  howso::TransformBuffer tf_buffer_{node_->get_clock()};
  howso_costmap_2d::ObservationBuffer buffer_{node_, "/observations", 10.0, 0.1, 0.0,

...
protected:
  void SetUp() override
  {
    ...
    client_ = costmap_->create_client<howso_msgs::srv::GetCosts>(
  ...
  howso::ServiceClient<howso_msgs::srv::GetCosts>::SharedPtr client_;
};

TEST_F(GetCostServiceTest, TestWithoutFootprint)
{
  auto request = std::make_shared<howso_msgs::srv::GetCosts::Request>();

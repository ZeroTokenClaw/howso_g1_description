...
#include "howso_costmap_2d/costmap_filters/keepout_filter.hpp"
...
protected:
  ...
  std::shared_ptr<howso_costmap_2d::KeepoutFilter> keepout_filter_;
...
void TestNode::createKeepoutFilter(const std::string & global_frame)
{
  ...
  keepout_filter_ = std::make_shared<howso_costmap_2d::KeepoutFilter>();
...
TEST_F(TestNode, testFreeMasterLethalKeepout)
{
  ...
  createMaps(howso_costmap_2d::FREE_SPACE, howso_util::OCC_GRID_OCCUPIED, "map");
  publishMaps();
  createKeepoutFilter("map");

  // Test KeepoutFilter
  testStandardScenario(howso_costmap_2d::FREE_SPACE, howso_costmap_2d::LETHAL_OBSTACLE);
...
TEST_F(TestNode, testUnknownMasterNonLethalKeepout)
{
  // Initialize test system
  createMaps(
    howso_costmap_2d::NO_INFORMATION,
    (howso_util::OCC_GRID_OCCUPIED - howso_util::OCC_GRID_FREE) / 2,
    "map");
  publishMaps();
  createKeepoutFilter("map");
  ...
  testStandardScenario(
    howso_costmap_2d::NO_INFORMATION,
    (howso_costmap_2d::LETHAL_OBSTACLE - howso_costmap_2d::FREE_SPACE) / 2);
...
{
  // Initialize test system
  createMaps(howso_costmap_2d::FREE_SPACE, howso_util::OCC_GRID_FREE, "map");
  publishMaps();
  createKeepoutFilter("map");
  ...
  verifyMasterGrid(howso_costmap_2d::FREE_SPACE, howso_costmap_2d::LETHAL_OBSTACLE);
...
{
  // Initialize test system
  createMaps(howso_costmap_2d::FREE_SPACE, howso_util::OCC_GRID_UNKNOWN, "map");
  publishMaps();
  createKeepoutFilter("map");
...
TEST_F(TestNode, testDifferentFrames)
{
  ...
  // Test KeepoutFilter
  testFramesScenario(howso_costmap_2d::FREE_SPACE, howso_costmap_2d::LETHAL_OBSTACLE);

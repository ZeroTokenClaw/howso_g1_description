...
#include "howso_costmap_2d/plugin_container_layer.hpp"
...
class TestLifecycleNode : public howso::LifecycleNode
{
public:
  explicit TestLifecycleNode(const string & name)
  : howso::LifecycleNode(name)
  {
  }

  howso::CallbackReturn on_configure(const rclcpp_lifecycle::State &)
  {
    return howso::CallbackReturn::SUCCESS;
  }

  howso::CallbackReturn on_activate(const rclcpp_lifecycle::State &)
  {
    return howso::CallbackReturn::SUCCESS;
  }

  howso::CallbackReturn on_deactivate(const rclcpp_lifecycle::State &)
  {
    return howso::CallbackReturn::SUCCESS;
  }

  howso::CallbackReturn on_cleanup(const rclcpp_lifecycle::State &)
  {
    return howso::CallbackReturn::SUCCESS;
  }

  howso::CallbackReturn onShutdown(const rclcpp_lifecycle::State &)
  {
    return howso::CallbackReturn::SUCCESS;
  }

  howso::CallbackReturn onError(const rclcpp_lifecycle::State &)
  {
    return howso::CallbackReturn::SUCCESS;
  }
};
...
TEST_F(TestNode, testObstacleLayers) {
  ...
  std::shared_ptr<howso_costmap_2d::PluginContainerLayer> pclayer_a = nullptr;
  addPluginContainerLayer(layers, tf, node_, pclayer_a, "pclayer_a");

  std::shared_ptr<howso_costmap_2d::PluginContainerLayer> pclayer_b = nullptr;
  addPluginContainerLayer(layers, tf, node_, pclayer_b, "pclayer_b");

  std::shared_ptr<howso_costmap_2d::ObstacleLayer> olayer_a =
    std::make_shared<howso_costmap_2d::ObstacleLayer>();
  pclayer_a->addPlugin(olayer_a, "pclayer_a.obstacles");

  std::shared_ptr<howso_costmap_2d::ObstacleLayer> olayer_b =
    std::make_shared<howso_costmap_2d::ObstacleLayer>();
  ...
  ASSERT_EQ(countValues(*costmap, howso_costmap_2d::LETHAL_OBSTACLE), 2);
}
...
TEST_F(TestNode, testObstacleAndStaticLayers) {
  ...
  std::shared_ptr<howso_costmap_2d::StaticLayer> slayer =
    std::make_shared<howso_costmap_2d::StaticLayer>();
  ...
  ASSERT_EQ(countValues(*costmap, howso_costmap_2d::LETHAL_OBSTACLE), 21);
}
...
TEST_F(TestNode, testDifferentInflationLayers) {
  ...
  std::shared_ptr<howso_costmap_2d::InflationLayer> ilayer_b =
    std::make_shared<howso_costmap_2d::InflationLayer>();
  ...
  ASSERT_EQ(countValues(*costmap, howso_costmap_2d::LETHAL_OBSTACLE), 21);
  ASSERT_EQ(countValues(*costmap, howso_costmap_2d::INSCRIBED_INFLATED_OBSTACLE), 4);
}
...
TEST_F(TestNode, testDifferentInflationLayers2) {
  ...
  std::shared_ptr<howso_costmap_2d::InflationLayer> ilayer_a =
    std::make_shared<howso_costmap_2d::InflationLayer>();
  ...
  ASSERT_EQ(countValues(*costmap, howso_costmap_2d::LETHAL_OBSTACLE), 21);
  ASSERT_EQ(countValues(*costmap, howso_costmap_2d::INSCRIBED_INFLATED_OBSTACLE), 28);
}
...
TEST_F(TestNode, testClearing) {
  ...
  ASSERT_EQ(countValues(*costmap, howso_costmap_2d::LETHAL_OBSTACLE), 21);
  ASSERT_EQ(countValues(*costmap, howso_costmap_2d::INSCRIBED_INFLATED_OBSTACLE), 29);
  ASSERT_EQ(olayer_b->getCost(9, 9), howso_costmap_2d::LETHAL_OBSTACLE);

  pclayer_a->clearArea(-1, -1, 10, 10, false);
  pclayer_b->clearArea(-1, -1, 10, 10, false);

  ASSERT_EQ(slayer->getCost(9, 0), howso_costmap_2d::LETHAL_OBSTACLE);
  ASSERT_EQ(olayer_b->getCost(9, 9), howso_costmap_2d::NO_INFORMATION);
}
...
TEST_F(TestNode, testOverwriteCombinationMethods) {
  ...
  ASSERT_EQ(countValues(*costmap, howso_costmap_2d::LETHAL_OBSTACLE), 1);
  ASSERT_EQ(countValues(*costmap, howso_costmap_2d::INSCRIBED_INFLATED_OBSTACLE), 2);
}
...
TEST_F(TestNode, testWithoutUnknownOverwriteCombinationMethods) {
  ...
  ASSERT_EQ(countValues(*costmap, howso_costmap_2d::NO_INFORMATION), 100);
}
...
TEST_F(TestNode, testClearable) {
  ...
  std::shared_ptr<howso_costmap_2d::StaticLayer> slayer_b =
    std::make_shared<howso_costmap_2d::StaticLayer>();
...
TEST_F(TestNode, testDynParamsSetPluginContainerLayer)
{
  ...
  costmap->declare_parameter(
    ...
    rclcpp::ParameterValue(std::string("howso_costmap_2d::PluginContainerLayer")));
  costmap->declare_parameter(
  ...
  costmap->declare_parameter(
    ...
    rclcpp::ParameterValue(std::string("howso_costmap_2d::ObstacleLayer")));
  costmap->declare_parameter(
    "plugin_container_layer_a.inflation_layer.plugin",
    rclcpp::ParameterValue(std::string("howso_costmap_2d::InflationLayer")));
  ...
  costmap->declare_parameter(
    ...
    rclcpp::ParameterValue(std::string("howso_costmap_2d::StaticLayer")));
  costmap->declare_parameter(

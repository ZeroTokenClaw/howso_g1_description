...
public:
  ...
  : topicName("/costmap"),
    node(std::make_shared<howso::LifecycleNode>("test_subscriber"))
  {
    ...
    dummyCostmapRawMsgSubscriber = node->create_subscription<howso_msgs::msg::Costmap>(
      topicName + "_raw",
    ...
    dummyCostmapRawUpdateMsgSubscriber =
      node->create_subscription<howso_msgs::msg::CostmapUpdate>(
  ...
  void SetUp() override
  {
    ...
    costmapSubscriber =
      std::make_unique<howso_costmap_2d::CostmapSubscriber>(node, topicName + "_raw");

    costmapToSend = std::make_shared<howso_costmap_2d::Costmap2D>(10, 10, 1.0, 0.0, 0.0);
  ...
  void costmapRawCallback(const howso_msgs::msg::Costmap::ConstSharedPtr)
  {
  ...
  void costmapRawUpdateCallback(const howso_msgs::msg::CostmapUpdate::ConstSharedPtr)
  {
...
protected:
  ...
  std::unique_ptr<howso_costmap_2d::CostmapSubscriber> costmapSubscriber;
  std::shared_ptr<howso_costmap_2d::Costmap2D> costmapToSend;
  std::vector<std::vector<uint8_t>> receivedGrids;
  howso::Subscription<nav_msgs::msg::OccupancyGrid>::SharedPtr dummyCostmapMsgSubscriber;
  howso::Subscription<howso_msgs::msg::Costmap>::SharedPtr dummyCostmapRawMsgSubscriber;
  howso::Subscription<map_msgs::msg::OccupancyGridUpdate>::SharedPtr
    dummyCostmapUpdateMsgSubscriber;
  howso::Subscription<howso_msgs::msg::CostmapUpdate>::SharedPtr dummyCostmapRawUpdateMsgSubscriber;
};
...
TEST_F(TestCostmapSubscriberShould, handleFullCostmapMsgs)
{
  ...
  auto costmapPublisher = std::make_shared<howso_costmap_2d::Costmap2DPublisher>(

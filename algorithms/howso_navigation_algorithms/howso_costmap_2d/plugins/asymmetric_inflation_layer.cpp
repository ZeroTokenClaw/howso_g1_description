...
PLUGINLIB_EXPORT_CLASS(howso_costmap_2d::AsymmetricInflationLayer, howso_costmap_2d::Layer)
...
{
  if (latest_global_path_ && *latest_global_path_ == *msg) {return;}

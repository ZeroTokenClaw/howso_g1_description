...
#ifndef HOWSO_CORE__SMOOTHER_HPP_
#define HOWSO_CORE__SMOOTHER_HPP_

#include <memory>
#include <string>

#include "howso_costmap_2d/costmap_subscriber.hpp"
#include "howso_costmap_2d/footprint_subscriber.hpp"
...
{
public:
  using Ptr = std::shared_ptr<howso_core::Smoother>;
  ...
  virtual void configure(
    const howso::LifecycleNode::WeakPtr &,
    std::string name, howso::TransformBuffer::SharedPtr,
    std::shared_ptr<howso_costmap_2d::CostmapSubscriber>,
    std::shared_ptr<howso_costmap_2d::FootprintSubscriber>) = 0;
...
#endif  // HOWSO_CORE__SMOOTHER_HPP_

...
#ifndef HOWSO_CORE__PATH_HANDLER_HPP_
#define HOWSO_CORE__PATH_HANDLER_HPP_
...
{
public:
  typedef std::shared_ptr<howso_core::PathHandler> Ptr;
  ...
  virtual void initialize(
    ...
    howso::TransformBuffer::SharedPtr tf) = 0;
...
#endif  // HOWSO_CORE__PATH_HANDLER_HPP_

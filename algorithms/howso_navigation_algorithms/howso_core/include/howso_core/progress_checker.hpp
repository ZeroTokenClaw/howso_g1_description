...
#ifndef HOWSO_CORE__PROGRESS_CHECKER_HPP_
#define HOWSO_CORE__PROGRESS_CHECKER_HPP_
...
{
/**
 * @class howso_core::ProgressChecker
...
{
public:
  typedef std::shared_ptr<howso_core::ProgressChecker> Ptr;
...
#endif  // HOWSO_CORE__PROGRESS_CHECKER_HPP_

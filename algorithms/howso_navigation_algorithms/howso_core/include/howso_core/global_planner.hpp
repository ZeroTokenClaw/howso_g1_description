...
#ifndef HOWSO_CORE__GLOBAL_PLANNER_HPP_
#define HOWSO_CORE__GLOBAL_PLANNER_HPP_
...
public:
  ...
  virtual void configure(
    ...
    std::shared_ptr<howso_costmap_2d::Costmap2DROS> costmap_ros) = 0;
...
#endif  // HOWSO_CORE__GLOBAL_PLANNER_HPP_

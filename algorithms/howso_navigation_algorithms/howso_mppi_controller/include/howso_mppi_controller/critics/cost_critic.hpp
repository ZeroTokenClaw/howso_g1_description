...
#ifndef HOWSO_MPPI_CONTROLLER__CRITICS__COST_CRITIC_HPP_
#define HOWSO_MPPI_CONTROLLER__CRITICS__COST_CRITIC_HPP_
...
protected:
  ...
  inline bool inCollision(float cost, float x, float y, float theta)
  {
    ...
    switch (static_cast<unsigned char>(score_cost)) {
      case (howso_costmap_2d::LETHAL_OBSTACLE):
        return true;
      case (howso_costmap_2d::INSCRIBED_INFLATED_OBSTACLE):
        return consider_footprint_ ? false : true;
      case (howso_costmap_2d::NO_INFORMATION):
  ...
  /**
    ...
    */
  inline float findCircumscribedCost(std::shared_ptr<howso_costmap_2d::Costmap2DROS> costmap);
...
#endif  // HOWSO_MPPI_CONTROLLER__CRITICS__COST_CRITIC_HPP_

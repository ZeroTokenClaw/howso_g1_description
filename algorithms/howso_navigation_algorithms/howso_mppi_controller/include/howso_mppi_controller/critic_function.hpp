...
#ifndef HOWSO_MPPI_CONTROLLER__CRITIC_FUNCTION_HPP_
#define HOWSO_MPPI_CONTROLLER__CRITIC_FUNCTION_HPP_
...
public:
  ...
  /**
    ...
    */
  void on_configure(
    howso::LifecycleNode::WeakPtr parent,
...
protected:
  ...
  howso_costmap_2d::Costmap2D * costmap_{nullptr};
...
#endif  // HOWSO_MPPI_CONTROLLER__CRITIC_FUNCTION_HPP_

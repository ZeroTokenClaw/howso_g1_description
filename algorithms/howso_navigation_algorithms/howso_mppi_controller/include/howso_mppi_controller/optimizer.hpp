...
#ifndef HOWSO_MPPI_CONTROLLER__OPTIMIZER_HPP_
#define HOWSO_MPPI_CONTROLLER__OPTIMIZER_HPP_
...
#include "howso_mppi_controller/critic_manager.hpp"
...
#include "howso_mppi_controller/tools/noise_generator.hpp"
#include "howso_mppi_controller/tools/parameters_handler.hpp"
#include "howso_mppi_controller/tools/utils.hpp"
#include "howso_mppi_controller/optimal_trajectory_validator.hpp"
...
public:
   ...
   */
  void initialize(
    howso::LifecycleNode::WeakPtr parent, const std::string & name,
    std::shared_ptr<howso_costmap_2d::Costmap2DROS> costmap_ros,
    howso::TransformBuffer::SharedPtr tf_buffer,
  ...
  std::tuple<geometry_msgs::msg::TwistStamped, Eigen::ArrayXXf> evalControl(
    ...
    const geometry_msgs::msg::Pose & goal, howso_core::GoalChecker * goal_checker);
...
protected:
  howso::LifecycleNode::WeakPtr parent_;
...
#endif  // HOWSO_MPPI_CONTROLLER__OPTIMIZER_HPP_

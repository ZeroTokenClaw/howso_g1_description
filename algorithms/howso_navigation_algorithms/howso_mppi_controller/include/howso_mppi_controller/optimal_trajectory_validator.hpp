...
#ifndef HOWSO_MPPI_CONTROLLER__OPTIMAL_TRAJECTORY_VALIDATOR_HPP_
#define HOWSO_MPPI_CONTROLLER__OPTIMAL_TRAJECTORY_VALIDATOR_HPP_
...
#include "howso_mppi_controller/tools/parameters_handler.hpp"
#include "howso_mppi_controller/models/control_sequence.hpp"
#include "howso_mppi_controller/models/optimizer_settings.hpp"
...
public:
  ...
  virtual void initialize(
    ...
    const std::shared_ptr<howso_costmap_2d::Costmap2DROS> costmap,
    ParametersHandler * param_handler,
    const howso::TransformBuffer::SharedPtr tf_buffer,
    const models::OptimizerSettings & settings)
  {
    ...
    if (consider_footprint_) {
      collision_checker_ = std::make_unique<howso_costmap_2d::FootprintCollisionChecker<
            howso_costmap_2d::Costmap2D *>>(costmap_ros_->getCostmap());
    }
  }
    ...
    const geometry_msgs::msg::Pose & /*goal*/)
  {
    ...
    for (size_t i = 0; i < traj_samples_to_evaluate_; ++i) {
      ...
      if (consider_footprint_) {
        ...
        if (footprint_cost == static_cast<double>(howso_costmap_2d::LETHAL_OBSTACLE)) {
        ...
        if (cost == howso_costmap_2d::INSCRIBED_INFLATED_OBSTACLE ||
          cost == howso_costmap_2d::LETHAL_OBSTACLE)
        {
          return ValidationResult::SOFT_RESET;
        }
      }
...
#endif  // HOWSO_MPPI_CONTROLLER__OPTIMAL_TRAJECTORY_VALIDATOR_HPP_

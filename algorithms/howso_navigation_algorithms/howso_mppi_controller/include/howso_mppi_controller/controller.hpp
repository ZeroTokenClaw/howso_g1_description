...
#ifndef HOWSO_MPPI_CONTROLLER__CONTROLLER_HPP_
#define HOWSO_MPPI_CONTROLLER__CONTROLLER_HPP_

#include <string>
#include <memory>

#include "howso_mppi_controller/optimizer.hpp"
#include "howso_mppi_controller/tools/trajectory_visualizer.hpp"
#include "howso_mppi_controller/models/constraints.hpp"
...
namespace howso_mppi_controller
{
 ...
 */
class MPPIController : public howso_core::Controller
{
public:
  /**
  ...
  void configure(
    ...
    std::string name, const howso::TransformBuffer::SharedPtr tf,
    const std::shared_ptr<howso_costmap_2d::Costmap2DROS> costmap_ros) override;
...
protected:
  ...
  howso::Publisher<nav_msgs::msg::Trajectory>::SharedPtr opt_traj_pub_;
...
#endif  // HOWSO_MPPI_CONTROLLER__CONTROLLER_HPP_

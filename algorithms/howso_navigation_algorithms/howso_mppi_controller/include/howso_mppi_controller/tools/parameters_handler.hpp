...
#ifndef HOWSO_MPPI_CONTROLLER__TOOLS__PARAMETERS_HANDLER_HPP_
#define HOWSO_MPPI_CONTROLLER__TOOLS__PARAMETERS_HANDLER_HPP_
...
public:
  ...
  explicit ParametersHandler(
    const howso::LifecycleNode::WeakPtr & parent, std::string & name);
...
protected:
  ...
  void setParam(
    ...
    howso::LifecycleNode::SharedPtr node) const;
...
void ParametersHandler::setParam(
  SettingT & setting, const std::string & name, howso::LifecycleNode::SharedPtr node) const
{
  ParamT param_in{};
...
#endif  // HOWSO_MPPI_CONTROLLER__TOOLS__PARAMETERS_HANDLER_HPP_

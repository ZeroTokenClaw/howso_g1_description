...
#include "howso_mppi_controller/critics/constraint_critic.hpp"
#include "howso_mppi_controller/critics/goal_angle_critic.hpp"
#include "howso_mppi_controller/critics/goal_critic.hpp"
#include "howso_mppi_controller/critics/obstacles_critic.hpp"
#include "howso_mppi_controller/critics/cost_critic.hpp"
#include "howso_mppi_controller/critics/path_align_critic.hpp"
#include "howso_mppi_controller/critics/path_angle_critic.hpp"
#include "howso_mppi_controller/critics/path_follow_critic.hpp"
#include "howso_mppi_controller/critics/prefer_forward_critic.hpp"
#include "howso_mppi_controller/critics/twirling_critic.hpp"
#include "howso_mppi_controller/critics/velocity_deadband_critic.hpp"
...
{
  // Standard preamble
  auto node = std::make_shared<howso::LifecycleNode>("my_node");
...
TEST(CriticTests, ObstacleCriticMisalignedParams) {
  ...
  EXPECT_THROW(
    critic.on_configure(node, "mppi", "critic", costmap_ros, &param_handler),
    howso_core::ControllerException
  );
}

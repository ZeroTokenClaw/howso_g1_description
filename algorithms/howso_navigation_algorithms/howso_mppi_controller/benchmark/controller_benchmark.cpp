  ...
  std::vector<std::string> critics, benchmark::State & state)
{
  ...
  auto broadcaster = howso::create_transform_broadcaster(node);
  auto tf_listener = howso::create_transform_listener(*tf_buffer, node);
  ...
  howso_core::GoalChecker * dummy_goal_checker{nullptr};

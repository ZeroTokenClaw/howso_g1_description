...
void MPPIController::configure(
  ...
  const std::shared_ptr<howso_costmap_2d::Costmap2DROS> costmap_ros)
{
  parent_ = parent;
  ...
  const geometry_msgs::msg::PoseStamped & global_goal)
{
  ...
  std::unique_lock<howso_costmap_2d::Costmap2D::mutex_t> costmap_lock(*(costmap->getMutex()));
...
PLUGINLIB_EXPORT_CLASS(howso_mppi_controller::MPPIController, howso_core::Controller)

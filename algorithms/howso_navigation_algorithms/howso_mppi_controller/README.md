...
controller_server:
  ros__parameters:
    ...
    FollowPath:
      plugin: "howso_mppi_controller::MPPIController"
      time_steps: 56
      model_dt: 0.05
      batch_size: 2000
      vx_std: 0.2
...
| `critics_stats`           | `howso_msgs/CriticsStats`         | Statistics about each critic's performance (published when `visualize` is enabled) |
...
The published `howso_msgs::msg::CriticsStats` message contains the following fields:

...
#ifndef HOWSO_NAVFN_PLANNER__NAVFN_PLANNER_HPP_
#define HOWSO_NAVFN_PLANNER__NAVFN_PLANNER_HPP_
...
#include "howso_navfn_planner/parameter_handler.hpp"
...
class NavfnPlanner : public howso_core::GlobalPlanner
{
public:
  /**
   * @brief constructor
...
protected:
  ...
  Parameters * params_;
  std::unique_ptr<howso_navfn_planner::ParameterHandler> param_handler_;
};

}  // namespace howso_navfn_planner

#endif  // HOWSO_NAVFN_PLANNER__NAVFN_PLANNER_HPP_

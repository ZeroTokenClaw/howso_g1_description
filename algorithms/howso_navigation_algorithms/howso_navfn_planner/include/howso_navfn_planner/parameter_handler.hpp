...
#ifndef HOWSO_NAVFN_PLANNER__PARAMETER_HANDLER_HPP_
#define HOWSO_NAVFN_PLANNER__PARAMETER_HANDLER_HPP_
...
/**
 * @class howso_navfn_planner::ParameterHandler
...
public:
  /**
   * @brief Constructor for howso_navfn_planner::ParameterHandler
   */
  ParameterHandler(
...
#endif  // HOWSO_NAVFN_PLANNER__PARAMETER_HANDLER_HPP_

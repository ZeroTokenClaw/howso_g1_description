...
#ifndef HOWSO_THETA_STAR_PLANNER__PARAMETER_HANDLER_HPP_
#define HOWSO_THETA_STAR_PLANNER__PARAMETER_HANDLER_HPP_
...
/**
 * @class howso_theta_star_planner::ParameterHandler
...
public:
  /**
   * @brief Constructor for howso_theta_star_planner::ParameterHandler
   */
  ParameterHandler(
...
#endif  // HOWSO_THETA_STAR_PLANNER__PARAMETER_HANDLER_HPP_

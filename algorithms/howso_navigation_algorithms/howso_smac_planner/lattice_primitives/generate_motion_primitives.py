...
from howso_smac_planner.lattice_primitives import constants
from howso_smac_planner.lattice_primitives.lattice_generator import ConfigDict, LatticeGenerator
from howso_smac_planner.lattice_primitives.trajectory import Trajectory
import numpy as np
...
def handle_arg_parsing() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Generate motionprimitives for Howso's State Lattice Planner"
    )
    parser.add_argument(
        '--config',
        type=Path,

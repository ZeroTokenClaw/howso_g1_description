...
#ifndef HOWSO_SMAC_PLANNER__COSTMAP_DOWNSAMPLER_HPP_
#define HOWSO_SMAC_PLANNER__COSTMAP_DOWNSAMPLER_HPP_
...
/**
 * @class howso_smac_planner::CostmapDownsampler
...
public:
   ...
   */
  void on_configure(
    const howso::LifecycleNode::WeakPtr & node,
    const std::string & global_frame,
    const std::string & topic_name,
    howso_costmap_2d::Costmap2D * const costmap,
   ...
   */
  howso_costmap_2d::Costmap2D * downsample(const unsigned int & downsampling_factor);
...
protected:
  ...
  std::unique_ptr<howso_costmap_2d::Costmap2D> _downsampled_costmap;
  std::unique_ptr<howso_costmap_2d::Costmap2DPublisher> _downsampled_costmap_pub;
};

}  // namespace howso_smac_planner

#endif  // HOWSO_SMAC_PLANNER__COSTMAP_DOWNSAMPLER_HPP_

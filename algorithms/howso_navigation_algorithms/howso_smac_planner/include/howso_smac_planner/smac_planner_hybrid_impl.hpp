...
#ifndef HOWSO_SMAC_PLANNER__SMAC_PLANNER_HYBRID_IMPL_HPP_
#define HOWSO_SMAC_PLANNER__SMAC_PLANNER_HYBRID_IMPL_HPP_
...
#include "howso_smac_planner/smac_planner_hybrid.hpp"
...
SmacPlannerHybridT<NodeT>::SmacPlannerHybridT()
: _a_star(nullptr),
...
template<typename NodeT>
void SmacPlannerHybridT<NodeT>::activate()
{
  RCLCPP_INFO(
  ...
  _post_set_params_handler = node->add_post_set_parameters_callback(
    std::bind(
      &SmacPlannerHybridT<NodeT>::updateParametersCallback,
...
template<typename NodeT>
void SmacPlannerHybridT<NodeT>::deactivate()
{
  RCLCPP_INFO(
...
template<typename NodeT>
void SmacPlannerHybridT<NodeT>::cleanup()
{
  RCLCPP_INFO(
...
#endif  // HOWSO_SMAC_PLANNER__SMAC_PLANNER_HYBRID_IMPL_HPP_

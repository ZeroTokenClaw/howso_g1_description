...
#ifndef HOWSO_SMAC_PLANNER__COLLISION_CHECKER_HPP_
#define HOWSO_SMAC_PLANNER__COLLISION_CHECKER_HPP_

namespace howso_smac_planner
{

/**
 * @class howso_smac_planner::GridCollisionChecker
 * @brief A costmap grid collision checker
 */
class GridCollisionChecker
  : public howso_costmap_2d::FootprintCollisionChecker<howso_costmap_2d::Costmap2D *>
{
public:
  /**
   * @brief A constructor for howso_smac_planner::GridCollisionChecker
  ...
  GridCollisionChecker(
    std::shared_ptr<howso_costmap_2d::Costmap2DROS> costmap,
   ...
   */
  void setFootprint(
    const howso_costmap_2d::Footprint & footprint,
    const bool & radius,
   ...
   * @return Costmap ros
   */
  std::shared_ptr<howso_costmap_2d::Costmap2DROS> getCostmapROS() {return costmap_ros_;}
...
protected:
  ...
  std::vector<howso_costmap_2d::Footprint> oriented_footprints_;
  howso_costmap_2d::Footprint unoriented_footprint_;
  float center_cost_;
...
#endif  // HOWSO_SMAC_PLANNER__COLLISION_CHECKER_HPP_

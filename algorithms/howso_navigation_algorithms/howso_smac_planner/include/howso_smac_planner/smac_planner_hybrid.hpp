...
#ifndef HOWSO_SMAC_PLANNER__SMAC_PLANNER_HYBRID_HPP_
#define HOWSO_SMAC_PLANNER__SMAC_PLANNER_HYBRID_HPP_
...
#include "howso_smac_planner/utils.hpp"
...
/**
 * @class howso_smac_planner::SmacPlannerHybridT
...
class SmacPlannerHybridT : public howso_core::GlobalPlanner
{
public:
  /**
   * @brief constructor
...
protected:
  ...
  howso_costmap_2d::Costmap2D * _costmap;
  std::shared_ptr<howso_costmap_2d::Costmap2DROS> _costmap_ros;
  ...
  howso::Publisher<nav_msgs::msg::Path>::SharedPtr _raw_plan_publisher;
  howso::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr
    _planned_footprints_publisher;
  howso::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr
    _smoothed_footprints_publisher;
  howso::Publisher<geometry_msgs::msg::PoseArray>::SharedPtr
    _expansions_publisher;
  std::mutex _mutex;
  howso::LifecycleNode::WeakPtr _node;
...
#include "howso_smac_planner/smac_planner_hybrid_impl.hpp"  // NOLINT

#endif  // HOWSO_SMAC_PLANNER__SMAC_PLANNER_HYBRID_HPP_

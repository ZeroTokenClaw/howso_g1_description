...
#ifndef HOWSO_SMAC_PLANNER__OBSTACLE_HEURISTIC_HPP_
#define HOWSO_SMAC_PLANNER__OBSTACLE_HEURISTIC_HPP_
...
/**
 * @class howso_smac_planner::ObstacleHeuristic
...
public:
  /**
   * @brief A constructor for howso_smac_planner::ObstacleHeuristic
   */
  ObstacleHeuristic() {}

  /**
   * @brief A destructor for howso_smac_planner::ObstacleHeuristic
   */
  ~ObstacleHeuristic() {}
  ...
  void resetObstacleHeuristic(
    std::shared_ptr<howso_costmap_2d::Costmap2DROS> costmap_ros_i,
...
#endif  // HOWSO_SMAC_PLANNER__OBSTACLE_HEURISTIC_HPP_

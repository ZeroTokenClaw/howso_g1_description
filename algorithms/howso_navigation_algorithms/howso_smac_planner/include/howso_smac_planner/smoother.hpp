...
#ifndef HOWSO_SMAC_PLANNER__SMOOTHER_HPP_
#define HOWSO_SMAC_PLANNER__SMOOTHER_HPP_
...
/**
 * @struct howso_smac_planner::BoundaryPoints
...
/**
 * @struct howso_smac_planner::BoundaryExpansion
...
/**
 * @class howso_smac_planner::Smoother
...
public:
  /**
   * @brief A constructor for howso_smac_planner::Smoother
   */
  explicit Smoother(const SmootherParams & params);

  /**
   * @brief A destructor for howso_smac_planner::Smoother
   */
  ~Smoother() {}
...
#endif  // HOWSO_SMAC_PLANNER__SMOOTHER_HPP_

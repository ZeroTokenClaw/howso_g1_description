...
#ifndef HOWSO_SMAC_PLANNER__A_STAR_HPP_
#define HOWSO_SMAC_PLANNER__A_STAR_HPP_
...
#include "howso_smac_planner/thirdparty/robin_hood.h"
#include "howso_smac_planner/analytic_expansion.hpp"
...
#include "howso_smac_planner/node_basic.hpp"
#include "howso_smac_planner/goal_manager.hpp"
...
/**
 * @class howso_smac_planner::AStarAlgorithm
...
public:
  ...
  /**
   * @struct howso_smac_planner::NodeComparator
  ...
  /**
   * @brief A constructor for howso_smac_planner::AStarAlgorithm
   */
  explicit AStarAlgorithm(const MotionModel & motion_model, const SearchInfo & search_info);

  /**
   * @brief A destructor for howso_smac_planner::AStarAlgorithm
   */
  ~AStarAlgorithm();
...
#include "howso_smac_planner/a_star_impl.hpp"  // NOLINT

#endif  // HOWSO_SMAC_PLANNER__A_STAR_HPP_

...
#ifndef HOWSO_SMAC_PLANNER__TYPES_HPP_
#define HOWSO_SMAC_PLANNER__TYPES_HPP_
...
/**
 * @struct howso_smac_planner::SearchInfo
...
/**
 * @struct howso_smac_planner::SmootherParams
 * @brief Parameters for the smoother
 */
struct SmootherParams
{
  /**
   * @brief A constructor for howso_smac_planner::SmootherParams
   */
  SmootherParams()
  : holonomic_(false)
  {
   ...
   */
  void get(howso::LifecycleNode::SharedPtr node, const std::string & name)
  {
...
/**
 * @struct howso_smac_planner::TurnDirection
...
/**
 * @struct howso_smac_planner::MotionPose
 * @brief A struct for poses in motion primitives
 */
struct MotionPose
{
  /**
   * @brief A constructor for howso_smac_planner::MotionPose
   */
  MotionPose() {}
...
/**
 * @struct howso_smac_planner::LatticeMetadata
...
/**
 * @struct howso_smac_planner::MotionPrimitive
...
/**
 * @struct howso_smac_planner::GoalState
...
/**
 * @class howso_smac_planner::Coordinates
...
{
  /**
   * @brief A constructor for howso_smac_planner::NodeHybrid::Coordinates
   */
  Coordinates() {}
...
#endif  // HOWSO_SMAC_PLANNER__TYPES_HPP_

...
#ifndef HOWSO_SMAC_PLANNER__ANALYTIC_EXPANSION_IMPL_HPP_
#define HOWSO_SMAC_PLANNER__ANALYTIC_EXPANSION_IMPL_HPP_
...
{
  // Node2D does not support analytic expansion
...
template<typename NodeT>
void AnalyticExpansion<NodeT>::cleanNode(const NodePtr & node)
{
  // NodeLattice needs to clear the motion primitive pointer
...
#endif  // HOWSO_SMAC_PLANNER__ANALYTIC_EXPANSION_IMPL_HPP_

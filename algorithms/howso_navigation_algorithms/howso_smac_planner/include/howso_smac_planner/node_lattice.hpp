...
#ifndef HOWSO_SMAC_PLANNER__NODE_LATTICE_HPP_
#define HOWSO_SMAC_PLANNER__NODE_LATTICE_HPP_
...
/**
 * @struct howso_smac_planner::LatticeMotionTable
 * @brief A table of motion primitives and related functions
 */
struct LatticeMotionTable
{
  /**
   * @brief A constructor for howso_smac_planner::LatticeMotionTable
   */
  LatticeMotionTable() {}
...
/**
 * @class howso_smac_planner::NodeLattice
...
public:
  ...
  /**
   * @brief A constructor for howso_smac_planner::NodeLattice
   * @param index The index of this node for self-reference
   */
  explicit NodeLattice(const uint64_t index, NodeContext * ctx);

  /**
   * @brief A destructor for howso_smac_planner::NodeLattice
   */
  ~NodeLattice();
  ...
  void getNeighbors(
    ...
    howso_smac_planner::NodeLattice * &)> & validity_checker,
    GridCollisionChecker * collision_checker,
    const bool & traverse_unknown,
...
#endif  // HOWSO_SMAC_PLANNER__NODE_LATTICE_HPP_

...
#ifndef HOWSO_SMAC_PLANNER__NODE_2D_HPP_
#define HOWSO_SMAC_PLANNER__NODE_2D_HPP_
...
/**
 * @class howso_smac_planner::Node2D
...
public:
  ...
  using Coordinates = howso_smac_planner::Coordinates2D;
  ...
  /**
   * @brief A constructor for howso_smac_planner::Node2D
   * @param index The index of this node for self-reference
   */
  explicit Node2D(const uint64_t index, NodeContext * ctx);

  /**
   * @brief A destructor for howso_smac_planner::Node2D
   */
  ~Node2D();
  ...
  void getNeighbors(
    ...
    howso_smac_planner::Node2D * &)> & validity_checker,
...
#endif  // HOWSO_SMAC_PLANNER__NODE_2D_HPP_

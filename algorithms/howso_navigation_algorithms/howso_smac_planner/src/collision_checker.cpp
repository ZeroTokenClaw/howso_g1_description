  ...
  const double & possible_collision_cost)
{
  ...
  if (possible_collision_cost_ <= 0.0f) {
    RCLCPP_ERROR_THROTTLE(
      ...
      "github.com/ros-planning/howso_navigation/tree/main/howso_smac_planner#potential-fields"
  ...
  for (unsigned int i = 0; i != angles_.size(); i++) {
    ...
    howso_costmap_2d::Footprint oriented_footprint;
  ...
  const bool & traverse_unknown)
{
  ...
  if (!footprint_is_radius_) {
    ...
    geometry_msgs::msg::Point new_pt;
    const howso_costmap_2d::Footprint & oriented_footprint = oriented_footprints_[angle_bin];
    howso_costmap_2d::Footprint current_footprint;

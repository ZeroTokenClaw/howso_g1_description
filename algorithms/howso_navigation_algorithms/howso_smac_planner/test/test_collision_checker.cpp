...
{
  auto node = std::make_shared<howso::LifecycleNode>("testA");
  howso_costmap_2d::Costmap2D * costmap_ = new howso_costmap_2d::Costmap2D(100, 100, 0.1, 0, 0, 0);
  ...
  howso_costmap_2d::Footprint footprint = {p1, p2, p3, p4};
  ...
  *costmap = *costmap_;
  ...
  howso_smac_planner::GridCollisionChecker collision_checker(costmap_ros, 72, node);
...
{
  auto node = std::make_shared<howso::LifecycleNode>("testB");
  howso_costmap_2d::Costmap2D * costmap_ = new howso_costmap_2d::Costmap2D(100, 100, 0.1, 0, 0, 0);
...
{
  auto node = std::make_shared<howso::LifecycleNode>("testC");
  howso_costmap_2d::Costmap2D * costmap_ = new howso_costmap_2d::Costmap2D(100, 100, 0.1, 0, 0, 0);
...
{
  auto node = std::make_shared<howso::LifecycleNode>("testD");
  howso_costmap_2d::Costmap2D * costmap_ = new howso_costmap_2d::Costmap2D(100, 100, 0.1, 0, 0, 254);
...
{
  auto node = std::make_shared<howso::LifecycleNode>("testE");
  howso_costmap_2d::Costmap2D * costmap_ = new howso_costmap_2d::Costmap2D(

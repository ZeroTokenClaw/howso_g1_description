...
class LatticeWrap : public howso_smac_planner::SmacPlannerLattice
{
public:
  ...
  howso_smac_planner::GoalHeadingMode getGoalHeadingMode()
  {
...
// System tests in howso_system_tests will actually plan with this work

TEST(SmacTest, test_smac_lattice)
{
  howso::LifecycleNode::SharedPtr nodeLattice =
    std::make_shared<howso::LifecycleNode>("SmacLatticeTest");
  ...
  std::shared_ptr<howso_costmap_2d::Costmap2DROS> costmap_ros =
    std::make_shared<howso_costmap_2d::Costmap2DROS>("global_costmap");
...
TEST(SmacTest, test_smac_lattice_reconfigure)
{
  ...
  EXPECT_EQ(planner->getGoalHeadingMode(), howso_smac_planner::GoalHeadingMode::BIDIRECTIONAL);
...
{
  howso::LifecycleNode::SharedPtr nodeLattice =
    std::make_shared<howso::LifecycleNode>("SmacLatticeOmniTest");
...
{
  howso::LifecycleNode::SharedPtr nodeLattice =
    std::make_shared<howso::LifecycleNode>("SmacLatticeOmniReconfigTest");

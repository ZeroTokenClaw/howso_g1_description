...
#include "howso_smac_planner/options.hpp"
...
/**
 * @struct howso_smac_planner::UnconstrainedSmootherCostFunction
...
public:
  /**
   * @brief A constructor for howso_smac_planner::UnconstrainedSmootherCostFunction
  ...
  {
    /**
     * @brief A constructor for howso_smac_planner::CurvatureComputations
     */
...
protected:
  ...
  int _num_params;
  howso_costmap_2d::Costmap2D * _costmap{nullptr};

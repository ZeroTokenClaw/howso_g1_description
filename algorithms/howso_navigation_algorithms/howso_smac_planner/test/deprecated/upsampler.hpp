...
#include "howso_smac_planner/upsampler_cost_function.hpp"
#include "howso_smac_planner/upsampler_cost_function_nlls.hpp"
...
/**
 * @class howso_smac_planner::Upsampler
...
public:
  /**
   * @brief A constructor for howso_smac_planner::Upsampler
   */
  Upsampler() {}

  /**
   * @brief A destructor for howso_smac_planner::Upsampler
   */
  ~Upsampler() {}

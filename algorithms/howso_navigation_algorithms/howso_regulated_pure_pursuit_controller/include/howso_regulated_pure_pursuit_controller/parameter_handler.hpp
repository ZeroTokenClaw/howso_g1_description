...
#ifndef HOWSO_REGULATED_PURE_PURSUIT_CONTROLLER__PARAMETER_HANDLER_HPP_
#define HOWSO_REGULATED_PURE_PURSUIT_CONTROLLER__PARAMETER_HANDLER_HPP_
...
#include "howso_util/parameter_handler.hpp"
...
/**
 * @class howso_regulated_pure_pursuit_controller::ParameterHandler
 * @brief Handles parameters and dynamic parameters for RPP
 */
class ParameterHandler : public howso_util::ParameterHandler<Parameters>
{
public:
  /**
   * @brief Constructor for howso_regulated_pure_pursuit_controller::ParameterHandler
   */
  ParameterHandler(
    const howso::LifecycleNode::SharedPtr & node,
...
#endif  // HOWSO_REGULATED_PURE_PURSUIT_CONTROLLER__PARAMETER_HANDLER_HPP_

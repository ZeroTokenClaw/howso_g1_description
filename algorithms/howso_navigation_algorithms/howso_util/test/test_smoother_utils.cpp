...
using howso_util::findDirectionalPathSegments;
using howso_util::updateApproximatePathOrientations;
...
geometry_msgs::msg::PoseStamped makePose(double x, double y, double yaw = 0.0)
{
  ...
  pose.pose.orientation = howso_util::geometry_utils::orientationAroundZAxis(yaw);
  return pose;
}

...
class TestParameterHandler : public howso_util::ParameterHandler<DummyParams>
{
public:
  TestParameterHandler(const howso::LifecycleNode::SharedPtr & node, rclcpp::Logger & logger)

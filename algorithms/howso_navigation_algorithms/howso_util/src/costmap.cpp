...
Costmap::Costmap(
  howso::LifecycleNode * node, bool trinary_costmap, bool track_unknown_space,
...
howso_msgs::msg::Costmap Costmap::get_costmap(
  const howso_msgs::msg::CostmapMetaData & /*specifications*/)
{
  ...
  howso_msgs::msg::Costmap costmap;

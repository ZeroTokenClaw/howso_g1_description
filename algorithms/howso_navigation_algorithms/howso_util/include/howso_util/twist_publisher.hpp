...
#ifndef HOWSO_UTIL__TWIST_PUBLISHER_HPP_
#define HOWSO_UTIL__TWIST_PUBLISHER_HPP_
...
/**
 * @class howso_util::TwistPublisher
...
protected:
  ...
  howso::Publisher<geometry_msgs::msg::Twist>::SharedPtr twist_pub_;
  howso::Publisher<geometry_msgs::msg::TwistStamped>::SharedPtr
    twist_stamped_pub_;
};

}  // namespace howso_util

#endif  // HOWSO_UTIL__TWIST_PUBLISHER_HPP_

...
#ifndef HOWSO_UTIL__SMOOTHER_UTILS_HPP_
#define HOWSO_UTIL__SMOOTHER_UTILS_HPP_
  ...
  bool is_holonomic = false)
{
  ...
  for (unsigned int i = 0; i != path.poses.size() - 1; i++) {
    ...
    path.poses[i].pose.orientation = howso_util::geometry_utils::orientationAroundZAxis(theta);
  }
}

}  // namespace howso_util

#endif  // HOWSO_UTIL__SMOOTHER_UTILS_HPP_

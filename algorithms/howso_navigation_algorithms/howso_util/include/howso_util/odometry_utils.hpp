...
#ifndef HOWSO_UTIL__ODOMETRY_UTILS_HPP_
#define HOWSO_UTIL__ODOMETRY_UTILS_HPP_
...
public:
  ...
  : odom_history_duration_(rclcpp::Duration::from_seconds(filter_duration))
  {
    ...
    odom_sub_ = howso::interfaces::create_subscription<nav_msgs::msg::Odometry>(
      parent, odom_topic,
...
protected:
  ...
  howso::Subscription<nav_msgs::msg::Odometry>::SharedPtr odom_sub_;
...
#endif  // HOWSO_UTIL__ODOMETRY_UTILS_HPP_

...
#ifndef HOWSO_UTIL__ROBOT_UTILS_HPP_
#define HOWSO_UTIL__ROBOT_UTILS_HPP_
...
bool getCurrentPose(
  ...
  howso::TransformBuffer & tf_buffer, const std::string global_frame = "map",
...
bool transformPoseInTargetFrame(
  ...
  howso::TransformBuffer & tf_buffer, const std::string target_frame,
...
#endif  // HOWSO_UTIL__ROBOT_UTILS_HPP_

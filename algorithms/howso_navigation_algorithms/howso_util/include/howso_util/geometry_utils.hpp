...
#ifndef HOWSO_UTIL__GEOMETRY_UTILS_HPP_
#define HOWSO_UTIL__GEOMETRY_UTILS_HPP_
...
#include "howso_msgs/msg/waypoint_status.hpp"
...
inline int find_next_matching_goal_in_waypoint_statuses(
  const std::vector<howso_msgs::msg::WaypointStatus> & waypoint_statuses,
  const geometry_msgs::msg::PoseStamped & goal)
{
  auto itr = std::find_if(
    waypoint_statuses.begin(), waypoint_statuses.end(),
    [&goal](const howso_msgs::msg::WaypointStatus & status) {
      return status.waypoint_pose == goal &&
             status.waypoint_status == howso_msgs::msg::WaypointStatus::PENDING;
    });
...
#endif  // HOWSO_UTIL__GEOMETRY_UTILS_HPP_

...
#ifndef HOWSO_UTIL__PARAMETER_HANDLER_HPP_
#define HOWSO_UTIL__PARAMETER_HANDLER_HPP_
...
public:
  /**
   * @brief Constructor for howso_util::ParameterHandler
   */
  ParameterHandler(
  ...
  /**
   * @brief Destructor for howso_util::ParameterHandler
   */
...
#endif  // HOWSO_UTIL__PARAMETER_HANDLER_HPP_

...
#ifndef HOWSO_UTIL__TWIST_SUBSCRIBER_HPP_
#define HOWSO_UTIL__TWIST_SUBSCRIBER_HPP_
...
/**
 * @class howso_util::TwistSubscriber
 ...
 * This approach allows HOWSO libraries to be flexible in which Twist message they support,
...
public:
  ...
  */
  ...
  explicit TwistSubscriber(
    ...
    const rclcpp::QoS & qos = howso::qos::StandardTopicQoS()
  )
  {
...
protected:
  ...
  howso::Subscription<geometry_msgs::msg::Twist>::SharedPtr twist_sub_ {nullptr};
  //! @brief The subscription when using TwistStamped
  howso::Subscription<geometry_msgs::msg::TwistStamped>::SharedPtr twist_stamped_sub_ {nullptr};
};


}  // namespace howso_util

#endif  // HOWSO_UTIL__TWIST_SUBSCRIBER_HPP_

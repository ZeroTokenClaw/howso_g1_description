...
#ifndef HOWSO_UTIL__COSTMAP_HPP_
#define HOWSO_UTIL__COSTMAP_HPP_
...
#include "howso_msgs/msg/costmap_meta_data.hpp"
#include "nav_msgs/msg/occupancy_grid.hpp"

namespace howso_util
{
...
public:
  ...
  /**
   * @brief A constructor for howso_util::Costmap
   ...
   */
  Costmap(
    howso::LifecycleNode * node, bool trinary_costmap = true, bool track_unknown_space = true,
   ...
   */
  howso_msgs::msg::Costmap get_costmap(const howso_msgs::msg::CostmapMetaData & specifications);

  /**
   * @brief Get a metadata message from this object
   * @return Costmap metadata of this costmap
   */
  howso_msgs::msg::CostmapMetaData get_properties() {return costmap_properties_;}
...
private:
  ...
  howso::LifecycleNode * node_;

  // TODO(orduno): For now, only holding costs from static map
  howso_msgs::msg::CostmapMetaData costmap_properties_;
...
#endif  // HOWSO_UTIL__COSTMAP_HPP_

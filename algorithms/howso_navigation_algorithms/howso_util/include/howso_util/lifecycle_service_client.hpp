...
#ifndef HOWSO_UTIL__LIFECYCLE_SERVICE_CLIENT_HPP_
#define HOWSO_UTIL__LIFECYCLE_SERVICE_CLIENT_HPP_
...
#include "howso_ros_common/service_client.hpp"
...
protected:
  howso::ServiceClient<lifecycle_msgs::srv::ChangeState> change_state_;
  howso::ServiceClient<lifecycle_msgs::srv::GetState> get_state_;
};

}  // namespace howso_util

#endif  // HOWSO_UTIL__LIFECYCLE_SERVICE_CLIENT_HPP_

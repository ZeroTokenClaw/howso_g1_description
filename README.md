...
项目已在 `algorithms/navigation2` 中加入华苏导航算法参考模块。该模块基于 ROS Navigation2 精选了路径规划、轨迹跟踪、代价地图和导航接口相关源码，用于机器人仿真平台后续的自主导航算法评估和集成设计。

当前包含 Smac Planner、Theta*、NavFn、MPPI Controller、Regulated Pure Pursuit Controller、Costmap 2D 以及相关接口与消息包。详细说明见 `algorithms/navigation2/README.md`。
